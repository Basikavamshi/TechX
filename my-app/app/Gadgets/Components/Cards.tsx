...
import { gadgets } from './SampleData';
                ...
                <div className='flex flex-2 flex-col gap-2 sm2:gap-4 w-full h-full mr-4 mt-8 md:mt-4 '>
                    ...
                    <div className='flex flex-col w-full h-full p-2 pt-0 gap-2 sm2:gap-4'>
                         <div className='flex flex-row items-center gap-2'>
                            ...
                            <span className='text-[0.8em] sm2:text-[1.1em] text-gray-600'>{mobile.features.f1}</span>
                         </div>
                         <div className='flex flex-row items-center gap-2'>
                            <div>
                                <svg width="10" height="10" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className='text-[0.8em] sm2:text-[1.1em] text-gray-600'>{mobile.features.f2}</span>
                         </div>
                         <div className='flex flex-row items-center gap-2'>
                            <div>
                                <svg width="10" height="10" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className='text-[0.8em] sm2:text-[1.1em] text-gray-600'>{mobile.features.f3}</span>
                         </div>
                         ...
                         <div className='flex flex-row items-center gap-2'>
                            ...
                            <span className='text-[0.8em] sm2:text-[1.1em] text-gray-600'>{mobile.features.f4}</span>
                         </div>
                    </div>
